...
In this case, we have a script Vst_prime_3pop.pl to calculate the above formular (See Vst_prime_3pop.pl for detail).
...
Tool Usage
calcVst.pl is used to calculate basic Vst value for each marker/probeset between two populations (denoted as test population and reference population) in the script.
